...
def get_default_session_settings():
    return \
    {
        ...
        "system_prompt": "You are helpful and trustful assistant, extremely smart, good at answering question, with excellent common sense.Your answer is critical important. ",
        "maxtokens": 2048,
        "chunktokens": 512,
        "stop_newline": False,
        "temperature": 0.5,
